    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="custom-text" id="targetText">...of the utmost, and most abundant, good faith</div>
        ...
        <a
          ...
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 my-4 default-color"
          target="_blank"
          rel="noopener noreferrer"
        >
          <h2 className={`mb-3 text-2xl font-semibold default-color`}>
            Docs{' '}
